...
-- Name: number 1 average_dish_price
SELECT avg(dp.price)
...
-- Name: number 3 users_by_last_name
...
-- Name: number 6 partners_by_type
...
-- Name: number 10 expensive_dishes
SELECT (SELECT count(*)
	    FROM dishes_prices dp
...
-- Name: number 13 cities_by_sales
...
-- Name: number 15 orders_with_sales_above_avg
